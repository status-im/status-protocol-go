...
func (m *ENSVerifier) verifyENSName(ensInfo enstypes.ENSDetails, ethclient *ethclient.Client) enstypes.ENSResponse { // TODO: replace ethclient.Client usage so we don't depend on Geth directly
