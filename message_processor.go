...
func (p *messageProcessor) Process(shhMessage *types.Message) ([]*protocol.Message, error) {
...
func (p *messageProcessor) handleMessages(shhMessage *types.Message, applicationLayer bool) ([]*protocol.StatusMessage, error) {
